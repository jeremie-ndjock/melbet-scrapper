...
| 12. Fil de match Telegram **(terminée, hors plan initial)** | Une mise à jour par manche (ligue, numéro du match du jour, vainqueur, temps, type de finishing), un message édité par match | Déployé et vérifié en production sur le VPS (4 matchs suivis en direct) ; 234 tests ; voir Memoire.md, section 23 |
