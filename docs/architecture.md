...
| 5. Normalisation et stockage | Dictionnaire, détecteur de changement, résultats et rattrapage | Environ 300 lignes pour un match de Mortal Kombat X ; résultats concordants |
